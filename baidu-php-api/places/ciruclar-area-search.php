...
$url = "http://api.map.baidu.com/place/v2/search?ak=".$api_key."&output=json&query=%E9%93%B6%E8%A1%8C&page_size=10&page_num=0&scope=1&location=".$location."&radius=".$radius;
