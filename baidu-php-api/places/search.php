...
$url = "http://api.map.baidu.com/place/v2/search?ak=".$api_key."&output=json&query=%E9%93%B6%E8%A1%8C&page_size=10&page_num=0&scope=1&region=%E5%8C%97%E4%BA%AC";
...
<html>
	...
	<style type="text/css">
        ...
        <script
            src="http://api.map.baidu.com/api?v=1.5&ak=<?php echo $api_key;  ?>"
